var viewlistservice = function ($http, listservice, infoservice) {
    ...
    var loadViewList = function () {
        var self = this;
        $http.get("/API/ViewList/")
...
listModule.factory("viewlistservice", viewlistservice);
